...
class Trigram:
    """From one or more text hgles, the frequency of three character
...
def test():
    en = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/en.txt')
   #NB fr and some others have English license text.
    #   no has english excerpts.
    fr = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/fr.txt')
    hg = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/hg.txt')
    jp = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/jp.txt')
    ru = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/ru.txt')
    zh = Trigram('/Users/hanxirui/Documents/workspace/github/python/python_pearl/tool/language/zh.txt')
    ...
    print("en - hg  is %s" % (en - hg)) 
    print("en - jp  is %s" % (en - jp)) 
    print("en - ru  is %s" % (en - ru)) 
    print("en - zh  is %s" % (en - zh)) 
    print("en - en  is %s" % (en - en)) 
    # print("jp - zh  is %s" % (jp - zh)) 
    # print("ru - zh  is %s" % (ru - zh)) 
    # print("en - zh  is %s" % (en - zh)) 
    # print("fr - zh  is %s" % (fr - zh)) 
