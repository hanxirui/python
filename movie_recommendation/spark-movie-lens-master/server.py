...
def init_spark_context():
    ...
    sc = SparkContext(conf=conf, pyFiles=['/Users/hanxirui/Documents/workspace/github/python/movie_recommendation/newmovierecom/engine.py', '/Users/hanxirui/Documents/workspace/github/python/movie_recommendation/newmovierecom/app.py'])
...
if __name__ == "__main__":
    ...
    # dataset_path = 'file:///Users/hanxirui/Documents/workspace/github/python/movie_recommendation/datasets/ml-latest'
    dataset_path = 'hdfs:///moviedatasets/datasets/ml-latest'
    print(dataset_path)
...
# http://localhost:5432/1/ratings/top/2
# http://localhost:5432/29592/ratings/42732
# http://localhost:5432/29592/ratings/top/2
